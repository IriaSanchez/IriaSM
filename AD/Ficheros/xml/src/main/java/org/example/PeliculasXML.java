...
public class PeliculasXML {
    public static void main(String[] args) {
        ...
        try {
            ...
            Document documento = (Document) creadorDocumento.parse("C:\\Users\\FP\\Desktop\\AccesoADatos\\Peliculas.xml");
            ...
            //Obtener la lista de nodos con NodeList que tiene etiqueta "PELICULA"
